...
As the optimal learning rate for reaching a minimum often changes as you iterate, several algorithms exist to adaptively change the learning rate during gradient descent. 
